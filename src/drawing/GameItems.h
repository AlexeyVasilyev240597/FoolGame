...
public:
  ...
  CARD_BTN(QPoint pos, CARD* c): CARD_ITEM(pos, c){ setAcceptHoverEvents(true); }
...
{
public:
    FOOL_PLAYER_SET_VIEW(QPoint pos, int w, int h):MY_ITEM(pos, w, h){}
...
{
public:
    FOOL_PRICUP_SET_VIEW(QPoint pos, int w, int h):MY_ITEM(pos, w, h){
        QPoint p(0, 0);//378);
